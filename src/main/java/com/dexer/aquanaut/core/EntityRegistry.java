...
public class EntityRegistry {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<ElectrofishEntity>> ELECTROFISH = ENTITIES.register(
            "electrofish",
            () -> EntityType.Builder
                    .<ElectrofishEntity>of(ElectrofishEntity::new, MobCategory.WATER_CREATURE)
                    .sized(1.15F, 1.35F)
                    .build("electrofish"));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<HelicoprionEntity>> HELICOPRION = ENTITIES.register(
            "helicoprion",
            () -> EntityType.Builder
                    .<HelicoprionEntity>of(HelicoprionEntity::new, MobCategory.WATER_CREATURE)
                    .sized(1.6F, 1.45F)
                    .build("helicoprion"));
